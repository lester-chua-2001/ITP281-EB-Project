...
public partial class DriverAccept : System.Web.UI.Page
{
    ...
    protected void bind()
    {
        ...
        orderList = aOrder.getOrderbyStatus("Accepted");
    ...
    protected void btn_Accepted_Click(object sender, EventArgs e)
    {
        ...
        int result = orders.orderUpdateStatus(order_id, "Collected");
        ...
        { // If validated properly
            ...
            string subject = "Collected";
            string body = "Order have been collected and on the way to shop";
    ...
    protected void btn_Rejected_Click(object sender, EventArgs e)
    {
        ...
        { // If validated properly
            ...
            string psender = "ebusinessnyp@gmail.com";
            string subject = "Collected";
            string body = "Order have been rejected try again later";
