<%@ Page Title="" Language="C#" MasterPageFile="~/drivernav.master" AutoEventWireup="true" CodeFile="DriverCollect.aspx.cs" Inherits="DriverCollect" %>
    ...
    <div class="container table-responsive table-condensed table-sm" style="margin: auto; justify-content: center;"">
        ...
        <Columns>
            ...
            <asp:TemplateField>
                ...
                <ItemTemplate>
                    <asp:Button ID="btn_Accepted" runat="server" Text="Drop Off" OnClick="btn_Accepted_Click" ControlStyle-CssClass="btn btn-outline-success"/>
