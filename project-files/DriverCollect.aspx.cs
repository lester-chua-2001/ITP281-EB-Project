...
public partial class DriverCollect : System.Web.UI.Page
{
    ...
    protected void bind()
    {
        ...
        orderList = aOrder.getOrderbyStatus("Collected");
    ...
    protected void btn_Accepted_Click(object sender, EventArgs e)
    {
        ...
        int result = orders.orderUpdateStatus(order_id, "Washing");
        ...
        { // If validated properly
            ...
            string subject = "Drop Off to shop";
            string body = "Order have been drop off and is ready to be wash at our shop.";
