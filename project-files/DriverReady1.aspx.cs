...
public partial class DriverReady1 : System.Web.UI.Page
{
    ...
    protected void bind()
    {
        ...
        orderList = aOrder.getOrderbyStatus("Ready");
    ...
    protected void btn_Accepted_Click(object sender, EventArgs e)
    {
        ...
        int result = orders.orderUpdateStatus(order_id, "Delivering");
        ...
        { // If validated properly
            ...
            string body = "Driver has collected from shop and on the way to deliver.";
