...
public partial class WasherWash1 : System.Web.UI.Page
{
    ...
    protected void bind()
    {
        ...
        orderList = aOrder.getOrderbyStatus("Washing");
    ...
    protected void btn_Accepted_Click(object sender, EventArgs e)
    {
        ...
        int result = orders.orderUpdateStatus(order_id, "Ready");
        ...
        { // If validated properly
            ...
            string subject = "Washed";
            string body = "Order have been washed. Ready to be delivery to you.";
